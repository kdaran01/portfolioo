...
const Contact = () => {
  ...
  return (
    <section className='contact section' id='contact'>
        <h2 className="section__title" data-aos="fade-down">Contact Me</h2>
        <span className="section__subtitle" data-aos="fade-down">Get in touch</span>
            ...
            <div className="contact__content" data-aos="fade-right">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">keerthidharan33@gmail.com</span><br />
                        <a href="mailto:keerthidharan33@gmail.com" className="contact__button" target='_blank'>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+91 9514692034</span><br/>
                        <a href="https://api.whatsapp.com/send?phone=9514692034&text=Hello!" className="contact__button" target='_blank'>
                            Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>
                    </div>
                </div>
